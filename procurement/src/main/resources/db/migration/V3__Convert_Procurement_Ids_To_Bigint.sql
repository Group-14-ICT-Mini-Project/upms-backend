-- Align procurement ID columns to BIGINT (equivalent to BIGSERIAL) when tables were created with INTEGER/SERIAL.
-- Hibernate maps Java Long IDs to BIGINT; this matches the BIGSERIAL PRIMARY KEY pattern used in the Auth Service schema.
-- Superseded V2, which was already applied to shared databases with different (INTEGER-converting) content.
...
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE procurement_methods ALTER COLUMN id TYPE BIGINT USING id::bigint;
        ...
        ALTER TABLE procurement_categories ALTER COLUMN id TYPE BIGINT USING id::bigint;
        ...
        ALTER TABLE procurements ALTER COLUMN id TYPE BIGINT USING id::bigint;
        ALTER TABLE procurements ALTER COLUMN procurement_method_id TYPE BIGINT USING procurement_method_id::bigint;
        ALTER TABLE procurements ALTER COLUMN procurement_category_id TYPE BIGINT USING procurement_category_id::bigint;
        ...
        ALTER TABLE rfq_recipients ALTER COLUMN id TYPE BIGINT USING id::bigint;
        ALTER TABLE rfq_recipients ALTER COLUMN procurement_id TYPE BIGINT USING procurement_id::bigint;
        ...
        ALTER TABLE newspaper_publications ALTER COLUMN id TYPE BIGINT USING id::bigint;
        ALTER TABLE newspaper_publications ALTER COLUMN procurement_id TYPE BIGINT USING procurement_id::bigint;
        ...
        ALTER TABLE promise_lk_posts ALTER COLUMN id TYPE BIGINT USING id::bigint;
        ALTER TABLE promise_lk_posts ALTER COLUMN procurement_id TYPE BIGINT USING procurement_id::bigint;
